...
- Stack: PocketBase (JSVM), PocketPages (SSR, file routing), EJS, HTMX, Alpine.js, CSS
...
- Class names describe their UI role; prefer BEM for reusable components
- Manage repeated values such as colors and spacing with CSS custom properties
- Use Lucide icons and manage them as `_private/icons/<name>.ejs` partials
- Icon partials contain only SVG markup; set size and color through classes and CSS at the usage site
