...
`
  ...
  function xe(t) {
    let e = [],
      r = (a) => e.push(a),
      [n, i] = tr(t);
    return (e.push(i), [{ Alpine: K, effect: n, cleanup: r, evaluateLater: x.bind(x, t), evaluate: N.bind(N, t) }, () => e.forEach((a) => a())]);
  }
  function Xn(t, e) {
    let r = () => {},
      n = Dt[e.type] || r,
    ...
    Rt(t, e.original, o);
    let s = () => {
      t._x_ignore || t._x_ignoreSelf || (n.inline && n.inline(t, e, i), (n = n.bind(n, t, e, i)), we ? _t.get(wr).push(n) : n());
    };
  ...
  var Ee = "DEFAULT",
    X = ["ignore", "ref", "data", "id", "anchor", "bind", "init", "for", "model", "modelable", "transition", "show", "if", Ee, "teleport"];
  function Qn(t, e) {
  ...
  var Cr = !1;
  function Tr() {
    (Cr && w("Alpine has already been initialized on this page. Calling Alpine.start() more than once can cause problems."),
      (Cr = !0),
      document.body || w("Unable to initialize. Trying to load Alpine before `<body>` is available. Did you forget to add `defer` in Alpine's `<script>` tag?"),
  ...
  function L(t, e) {
    if (t) {
      if (e(t)) return t;
      if ((t._x_teleportBack && (t = t._x_teleportBack), t.parentNode instanceof ShadowRoot)) return L(t.parentNode.host, e);
  ...
  function S(t, e = $, r = () => {}) {
    L(t, (n) => n._x_ignore) ||
      Er(() => {
        e(t, (n, i) => {
          n._x_marker || (r(n, i), Dr.forEach((o) => o(n, i)), gt(n, n.attributes).forEach((o) => o()), n._x_ignore || (n._x_marker = ti++), n._x_ignore && i());
        });
      });
  }
  function j(t, e = $) {
  ...
  function xt(t, e) {
    return Array.isArray(e) ? $r(t, e.join(" ")) : typeof e == "object" && e !== null ? ri(t, e) : typeof e == "function" ? xt(t, e()) : $r(t, e);
  }
  function $r(t, e) {
  ...
  function ai(t, e, r) {
    ...
    (e.includes("in") && !n && (e = e.filter((m, b) => b < e.indexOf("out"))), e.includes("out") && !n && (e = e.filter((m, b) => b > e.indexOf("out"))));
    ...
    (i &&
      ((t._x_transition.enter.during = { transformOrigin: v, transitionDelay: `${p}s`, transitionProperty: O, transitionDuration: `${R}s`, transitionTimingFunction: f }),
      (t._x_transition.enter.start = { opacity: l, transform: `scale(${u})` }),
      (t._x_transition.enter.end = { opacity: 1, transform: "scale(1)" })),
      o &&
        ((t._x_transition.leave.during = { transformOrigin: v, transitionDelay: `${p}s`, transitionProperty: O, transitionDuration: `${_}s`, transitionTimingFunction: f }),
  ...
  window.Element.prototype._x_toggleAndCascadeWithTransitions = function (t, e, r, n) {
    ...
    if (e) {
      t._x_transition && (t._x_transition.enter || t._x_transition.leave)
        ? t._x_transition.enter && (Object.entries(t._x_transition.enter.during).length || Object.entries(t._x_transition.enter.start).length || Object.entries(t._x_transition.enter.end).length)
  ...
  function ci(t, e) {
    let r,
      ...
      o = yt(() => {
        h(() => {
          ((r = !0), n || e.before(), i || (e.end(), jt()), e.after(), t.isConnected && e.cleanup(), delete t._x_transitioning);
        });
      });
    ((t._x_transitioning = {
      beforeCancels: [],
  ...
  function wt(t, e, r, n = []) {
    switch ((t._x_bindings || (t._x_bindings = M({})), (t._x_bindings[e] = r), (e = n.includes("camel") ? gi(e) : e), e)) {
      case "value":
        ui(t, r);
        break;
      case "style":
  ...
  function ui(t, e) {
    if (Te(t)) (t.attributes.value === void 0 && (t.value = e), window.fromModel && (typeof e == "boolean" ? (t.checked = Et(t.value) === e) : (t.checked = Vr(t.value, e))));
    else if (zt(t))
      Number.isInteger(e)
        ? (t.value = e)
  ...
  function Zr(t, e) {
    ...
    ((et[t] = e), ot(et[t]), typeof e == "object" && e !== null && e.hasOwnProperty("init") && typeof e.init == "function" && et[t].init());
  }
  function Qr() {
    return et;
  }
  ...
  var Gs = Ne(wi + ",async,autofocus,autoplay,controls,default,defer,disabled,hidden,loop,open,required,reversed,scoped,seamless,checked,muted,multiple,selected");
  ...
  function Ri(t, e) {
    ...
    return ((r.id = Ti++), (r.allowRecurse = !!e.allowRecurse), (r._isEffect = !0), (r.active = !0), (r.raw = t), (r.deps = []), (r.options = e), r);
  }
  function _n(t) {
    let { deps: e } = t;
    if (e.length) {
  ...
  function k(t, e, r) {
    ...
    let i = n.get(r);
    (i || n.set(r, (i = new Set())), i.has(B) || (i.add(B), B.deps.push(i), B.options.onTrack && B.options.onTrack({ effect: B, target: t, type: e, key: r })));
  }
  ...
  function yn(t = !1, e = !1) {
    return function (n, i, o) {
      ...
      return (Ut(i) ? xn.has(i) : ki(i)) || (t || k(n, "get", i), e) ? a : Le(a) ? (!s || !qt(i) ? a.value : a) : St(a) ? (t ? Sn(a) : te(a)) : a;
    };
  }
  var $i = Li();
  function Li(t = !1) {
  ...
  function bn(t, e) {
    ...
    return (n, i, o) => (i === "__v_isReactive" ? !t : i === "__v_isReadonly" ? t : i === "__v_raw" ? n : Reflect.get(vt(r, i) && i in n ? r : n, i, o));
  }
  var Gi = { get: bn(!1, !1) };
  var Ji = { get: bn(!0, !1) };
  function wn(t, e, r) {
  ...
  function Tn(t, e, r) {
    y(e, (n) => w(`You can't use [$${e}] without first installing the "${t}" plugin here: https://alpinejs.dev/plugins/${r}`, n));
  }
  ...
  function ao(t, e) {
    ...
    return (
      ...
      !(i.length > 0 && i.filter((s) => ((s === "cmd" || s === "super") && (s = "meta"), t[`${s}Key`])).length === i.length && (kn(t.type) || Nn(t.key).includes(r[0])))
    );
  }
  function Nn(t) {
    if (!t) return [];
  ...
  d("model", (t, { modifiers: e, expression: r }, { effect: n, cleanup: i }) => {
    ...
    if (
      (e.includes("fill") && ([void 0, null, ""].includes(c()) || (zt(t) && Array.isArray(c())) || (t.tagName.toLowerCase() === "select" && t.multiple)) && l(re(t, e, { target: t }, c())),
    ...
    ((t._x_model = {
      ...
      (t._x_forceModelUpdate = (_) => {
        (_ === void 0 && typeof r == "string" && r.match(/\./) && (_ = ""), (window.fromModel = !0), h(() => wt(t, "value", _)), delete window.fromModel);
      }),
      n(() => {
        let _ = c();
    ...
    return h(() => {
      ...
      if (zt(t))
        if (Array.isArray(n)) {
          let i = null;
          return (
            e.includes("number") ? (i = Ve(r.target.value)) : e.includes("boolean") ? (i = Et(r.target.value)) : (i = r.target.value),
        ...
        {
          let i;
          return (Te(t) ? (r.target.checked ? (i = r.target.value) : (i = n)) : (i = r.target.value), e.includes("number") ? Ve(i) : e.includes("boolean") ? Et(i) : e.includes("trim") ? i.trim() : i);
        }
      }
    });
  }
  ...
  d("show", (t, { modifiers: e, expression: r }, { effect: n }) => {
    ...
    let o = () => {
      ...
      c = yt(
        (p) => (p ? s() : o()),
        (p) => {
          typeof t._x_toggleAndCascadeWithTransitions == "function" ? t._x_toggleAndCascadeWithTransitions(t, p, s, o) : p ? a() : o();
        },
      ),
      l,
      u = !0;
  ...
  ne("Mask", "mask", "mask");
  function ne(t, e, r) {
    d(e, (n) => w(`You can't use [x-${e}] without first installing the "${t}" plugin here: https://alpinejs.dev/plugins/${r}`, n));
  }
  K.setEvaluator(be);
