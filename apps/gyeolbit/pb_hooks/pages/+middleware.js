...
function renderErrorPage(title, message, detail) {
  ...
  return (
    ...
    + '<p style="margin:0 0 10px;font-size:12px;font-weight:700;letter-spacing:.12em;color:#64748b;text-transform:uppercase;">gyeolbit</p>'
...
module.exports = function (api, next) {
  ...
  try {
    ...
    error('gyeolbit/global-error-boundary:caught', {
      pathname: pathname,
    ...
    if (isXapiPath(pathname)) {
      ...
      dbg('gyeolbit/global-error-boundary:redirect', {
        status: 303,
        redirectTo: '/',
