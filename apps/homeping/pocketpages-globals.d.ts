...
type PocketBaseHttpApi = {
  send: (config: { url: string; method?: string; body?: string; headers?: Record<string, string>; timeout?: number }) => PocketBaseHttpResponse
}
...
declare global {
  ...
  // PocketBase JSVM HTTP helper
  const $http: PocketBaseHttpApi
}
